...
//        setContentView(R.layout.reteta_ingrediente); // Ensure this layout file exists
//
//        // Setup back button
...
//        Steps= findViewById(R.id.button2);
//        Steps.setOnClickListener(v -> startActivity(new Intent(this, RecipeDetails_Steps.class)));
//
//        // JSON data string
...
//
//        // Assume you only need the first recipe's ingredients for this example
//        JsonObject firstRecipe = recipesArray.get(0).getAsJsonObject();
//        JsonArray ingredientsArray = firstRecipe.getAsJsonArray("ingredients");
//
//        // Convert JSON ingredients to a list of strings
//        List<String> ingredientList = new ArrayList<>();
//        for (int i = 0; i < ingredientsArray.size(); i++) {
//            ingredientList.add(ingredientsArray.get(i).getAsString());
//        }
//
//        // Set up TextViews and ImageView
//        TextView recipeName = findViewById(R.id.recipeName);
//        recipeName.setText(firstRecipe.get("name").getAsString());
//
//        ImageView recipeImage = findViewById(R.id.pozafundal);
//        String imageStr = firstRecipe.get("image").getAsString();
//        int imageResId = getResources().getIdentifier(imageStr, "drawable", getOpPackageName());
//        if (imageResId != 0) {
//            recipeImage.setImageResource(imageResId);
//        }
//
//        // Set up RecyclerView for ingredients
//        ingredientRecyclerView = findViewById(R.id.lista);
//        ingredientRecyclerView.setLayoutManager(new LinearLayoutManager(this));
//
//        // Initialize the IngredientsAdapter with the list of ingredients
//        adapter ingredientsAdapter = new adapter(ingredientList); // Ensure this class exists and works properly
//        ingredientRecyclerView.setAdapter(ingredientsAdapter);
//
//        // Log for debugging
//        Log.d("RecipeDetailsActivity", "Number of ingredients: " + ingredientList.size());
//    }
//}
